...
def change_password(user_id):
    ...
    # ``force_change`` is the admin-reset handshake for admin-assisted
    # recovery: when true + admin + target != self, the target's
    # must_change_password flag stays set so they have to rotate on next
    # login. Accepted but silently ignored on self-change — enforced in
    # user_service.
