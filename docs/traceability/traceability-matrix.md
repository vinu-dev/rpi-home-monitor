...
| System requirements | SYS-001 through SYS-035 plus SYS-099 and SYS-101 are linked to user needs, lower-level requirements, architecture, risks, controls, and tests. |
| Software requirements | SWR-001 through SWR-071 plus SWR-099 and SWR-101-A through SWR-101-C each have at least one linked test case. |
...
| Tests | TC-001 through TC-056 plus TC-099 and TC-101-AC-1 through TC-101-AC-14 have linked requirements. |
