...
| ARCH-003 | Data and recording boundary | Recordings, config, certificates, logs, and OTA state live under `/data` or configured external storage. | SYS-002, SYS-003, SYS-010 | RISK-003, RISK-006 | SC-005, SC-008 | TC-003, TC-017 | `docs/history/baseline/architecture.md` |
