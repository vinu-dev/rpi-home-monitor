...
| SWA-013 | User administration | User API/service handles account lifecycle, password policy, roles, last-admin protections, and audit. | SWR-023 | RISK-011, RISK-002 | SC-011, SC-008 | TC-022, TC-011 | `api/users.py`, `user_service.py`, `auth.py` |
| SWA-014 | Settings, time, and WiFi | Server and camera settings paths handle time, timezone, WiFi, hostname, redaction, and validation. | SWR-024, SWR-035, SWR-036 | RISK-012, RISK-010 | SC-012, SC-020 | TC-023, TC-033, TC-034 | `api/settings.py`, `settings_service.py`, `wifi_setup.py` |
