...
| SWA-006 | OTA services | Bundle staging, reusable camera bundle library, verification, camera-owned activation reboot, target-version confirmation, update status, and install command boundary. | SWR-010, SWR-016, SWR-038 | RISK-004 | SC-003, SC-005 | TC-009, TC-013, TC-036 | `ota_service.py`, `camera_ota_client.py`, `ota_agent.py`, `ota_installer.py` |
