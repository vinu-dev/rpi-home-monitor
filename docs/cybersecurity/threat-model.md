...
| THREAT-099 | Elevation/Information disclosure | Compromised admin action or leaked recovery guidance abuses the admin-assisted password-reset path to lock out users or map recovery internals. | Settings â†’ Users password reset flow, login-page recovery hint, audit-log review. | User lockout or an expanded recovery attack surface. | SC-099, SC-008 | SYS-099, SWR-099 | TC-099 | Draft |
